...
function doGet(e){
  ...
  var ss=SpreadsheetApp.openByUrl("https://docs.google.com/spreadsheets/d/1XPm7ngP2w5xSsVvnOvNRmDPCGLaRZej6v0tTl-6wLZg/");
 ...
 /*
  var template = HtmlService.createTemplateFromFile('crud_test');
